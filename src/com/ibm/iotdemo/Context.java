...
public class Context {
	...
	public static Context get() { return singleton; }
	
	// TODO: Ayan to initialize various devices here
	protected DeviceLocalInterface[]	prebuiltDevices = { 
		new DeviceDummy(AuthenticationMethod.UIDPWD), 
		new DeviceDummy(AuthenticationMethod.OTP), 
		new DeviceDummy(AuthenticationMethod.CERTIFICATE) 
	};
